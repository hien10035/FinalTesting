...
public class Testcase_StartNewDiscusion {
...
@SuppressWarnings("deprecation")
	...
	public void testSetup() throws Exception{
		...
		baseUrl="https://github.com/login?return_to=https%3A%2F%2Fgithub.com%2Ftrieunhat2806%2FFINAL-PROJECT-TESTING%2Fdiscussions%2Fnew%3Fcategory%3Dgeneral";
		driver.get(baseUrl);
	...
	public void test() throws Exception{
		...
		Assert.assertTrue(actualText.matches(".*general.*"), "Text not found: Send feedback");
